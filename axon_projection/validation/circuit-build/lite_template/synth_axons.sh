...
nohup /gpfs/bbp.cscs.ch/project/proj135/home/petkantc/axon/axonal-projection/axon_projection/validation/circuit-build/adrien_axon_synth.sh ${SIM_FOLDER} ${A_S_CFG} ${FILTERED_COLLECTION_PATH} ${A_P_OUT} &> ${LOG_LOC} &
